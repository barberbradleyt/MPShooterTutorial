...
void AShotgun::MultiTraceEndWithScatter(const FVector& HitTarget, TArray<FVector_NetQuantize>& HitTargets)
{
	const USkeletalMeshSocket* MuzzleFlashSocket = GetWeaponMesh()->GetSocketByName("MuzzleFlash");
	...
	for (uint32 i = 0; i < NumberOfPellets; i++) 
	{
		...
		ToEndLocation = TraceStart + ToEndLocation * SHOT_TRACE_LENGTH / ToEndLocation.Size();
